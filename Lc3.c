...
enum{
    TRAP_GETC = 0x20, /* get character from keyboard, not echoed onto the termineal */
    TRAP_OUT =  0x21, /* output a char */
    TRAP_PUTS=  0x22, /* output a word string */
    TRAP_IN =   0x23, /* get char from keyboard */
...
// BUG there is some err in my own code i well fix it in future
        ...
        /*     case OP_BR :{ */
        /*         uint16_t cond_flag = (instr >> 9) & 0x7; */
        /*         int16_t offset = sign_extend(instr & 0x1FF, 9); */
        /*         if(cond_flag & reg[R_COND]){ */
        /*             reg[R_PC] += offset; */
        /*         } */
        /*     } */
        ...
        /* case OP_RTI: */
        /* default : */
        /*     fprintf(stderr, "Unsupported opcode: 0x%x at PC=0x%x\n", op, reg[R_PC]-1);           */
        /*     abort(); */
        /*     break; */
        /* } */
    }
